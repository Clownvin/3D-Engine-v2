...
public final class TimeProfiler {
	...
	private final int DEFAULT_OUTPUT_FREQUENCY = 100;
	...
	public void stop() {
		...
		case 0:
			...
			if (++count == outputFrequency) {
				System.out.println(name+", average time over "+outputFrequency+" ticks: "+(cumulative / outputFrequency)+"ms");
				count = 0;
				cumulative = 0;
			}
			return;
		case 1:
			...
			if (++count == outputFrequency) {
				System.out.println(name+", average time over "+outputFrequency+" ticks: "+(cumulative / outputFrequency)+"ns");
				count = 0;
				cumulative = 0;
			}
			return;
