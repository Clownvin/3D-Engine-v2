...
public enum ColorPalette {
	BLACK(Color.BLACK), GRAY_1(new Color(255 / 10, 255 / 10, 255 / 10)), SEAFOAM(
			...
			Color.MAGENTA), ORANGE(Color.ORANGE), YELLOW(Color.YELLOW), PURPLE(
			mixColors(Color.RED, Color.BLUE));
	...
	public static Color lightFilter(Color original, Color light) {
		...
		return new Color((int) rPercent * light.getRed(), (int) gPercent * light.getGreen(), (int) bPercent * light.getBlue());
